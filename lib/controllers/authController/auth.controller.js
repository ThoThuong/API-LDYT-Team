...
exports.AuthController = {
    login: async function (collection, model) {
        ...
        if (user && services_1.PasswordService.compare(model.body.password, (_a = user === null || user === void 0 ? void 0 : user.password) !== null && _a !== void 0 ? _a : '')) {
            return services_1.AuthService.generateToken(user.username, (_b = user === null || user === void 0 ? void 0 : user.roles) !== null && _b !== void 0 ? _b : [], user._id);
        }
    ...
    register: async function (collection, model) {
        ...
        if (user) {
            ...
            return services_1.AuthService.generateToken(user.username, (_a = user === null || user === void 0 ? void 0 : user.roles) !== null && _a !== void 0 ? _a : [], user._id);
        }
    }
};
